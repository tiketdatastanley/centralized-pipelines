...
def pipeline(num1: float, num2: float, num3: float):
    ...
    url_op1 = "https://raw.githubusercontent.com/tiketdatastanley/centralized-operators/release/multiply_op/v1.0/manifests/multiply_op.yaml"
    url_op2 = "https://raw.githubusercontent.com/tiketdatastanley/centralized-operators/release/sum_op/v1.0/manifests/sum_op.yaml"
...
if __name__ == "__main__":
    Compiler().compile(
        ...
        package_path="./manifests/multiply_sum_pipeline.yaml",
    )